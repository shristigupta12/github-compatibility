    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-neutral-50 px-4 py-8">
      <div className="w-full max-w-2xl">
        <div className="flex flex-col items-center mb-8">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mb-4">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            <path d="M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5" />
          </svg>
          <h1 className="text-4xl font-bold text-center text-neutral-800 mb-8">Github Compatibility</h1>
        </div>

        <div className="grid md:grid-cols-2 gap-6">
          <div className="flex flex-col">
            <label htmlFor="username1" className="text-lg font-semibold text-neutral-800 mb-2">Your username</label>
            <Input 
              id="username1"
              className="bg-white font-semibold py-2 border-neutral-400 text-lg"
              type="text" 
              value={inputName1} 
              onChange={handleInputNameChange1} 
            />
            {errors.username1 && <div className="text-red-500 text-sm mt-1">{errors.username1}</div>}
          </div>
          
          <div className="flex flex-col">
            <label htmlFor="username2" className="text-lg font-semibold text-neutral-800 mb-2">Their username</label>
            <Input 
              id="username2"
              className="bg-white font-semibold py-2 border-neutral-400 text-lg"
              type="text" 
            ...
            />
            {errors.username2 && <div className="text-red-500 text-sm mt-1">{errors.username2}</div>}
          </div>
        </div>
